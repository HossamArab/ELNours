...
{
    public partial class frmManageRecieve : DevExpress.XtraEditors.XtraForm
    {
        DatabaseConnection con;
        private readonly Fills fills = new Fills();
        public frmManageRecieve()
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            ...
            Search();
            fills.fillComboBox(cmbVendor, "Vendor_tbl", "Id", "Name", "Type", 0);
        ...
        private void GetData(string condition)
        {
            try
            {
                ...
                WHERE 
                    Recieve_tbl.Type = 0 AND " + condition + @"
                ORDER BY 
                    Recieve_tbl.Id"
                ;

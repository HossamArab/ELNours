...
{
    public partial class frmImportImprter : DevExpress.XtraEditors.XtraForm
    {
        DatabaseConnection con;
        DatabaseOperation oper;
        SqlCommand cmd;
        public frmImportImprter()
        {
            InitializeComponent();
            ...
            try
            {
                        ...
                        Dictionary<string, object> ProductData = new Dictionary<string, object>
                {
                    ...
                    {"Type", 0},
                        ...
                        await Task.Run(() => oper.Insert("Vendor_tbl", ProductData)).ConfigureAwait(false);
                    }
